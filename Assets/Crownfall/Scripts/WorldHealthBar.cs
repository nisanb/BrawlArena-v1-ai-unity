...
namespace Crownfall
{
    ...
    public class WorldHealthBar : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            shown = Mathf.Lerp(shown, f, 14f * Time.deltaTime);
            ghostShown = Mathf.Lerp(ghostShown, f, 3f * Time.deltaTime);
            ...
            if (group != null)
            {
                ...
                float want = health.IsDead || isActivePlayer || matchOver ? 0f : 1f;
